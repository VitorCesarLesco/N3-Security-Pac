@echo off
title Keycloak Server - Simples
cls
echo ====================================================
echo KEYCLOAK - VERSAO SIMPLIFICADA
echo ====================================================
echo.

echo [1] Parando processos Java anteriores...
...
REM Executa o Keycloak usando o comando correto
java -jar ../lib/quarkus-run.jar start-dev --http-port=8080
